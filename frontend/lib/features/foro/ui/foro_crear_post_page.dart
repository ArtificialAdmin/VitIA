...
class ForoCrearPostPage extends ConsumerStatefulWidget {
  final VoidCallback? onPostCreated;
  final VoidCallback? onCancel;

  const ForoCrearPostPage({super.key, this.onPostCreated, this.onCancel});

  @override
  ConsumerState<ForoCrearPostPage> createState() => _ForoCrearPostPageState();
}

class _ForoCrearPostPageState extends ConsumerState<ForoCrearPostPage> {
  ...
  Future<void> _handlePublish() async {
    ...
    try {
      ...
      await ref.read(apiProvider).createPublicacion(
