...
class ForoPrincipalPage extends ConsumerStatefulWidget {
  const ForoPrincipalPage({super.key});

  @override
  ConsumerState<ForoPrincipalPage> createState() => _ForoPageState();
}

class _ForoPageState extends ConsumerState<ForoPrincipalPage>
  ...
  void _cargarDatos() {
    ref.read(foroProvider.notifier).reload();
  }
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
                  ...
                  child: forumState.when(
                    ...
                    error: (err, stack) => Center(child: Text("Error: $err")),
                      data: (allPosts) {
                        ...
                        final List<Map<String, dynamic>> filteredPop =
            ...
            if (!_isSearching && !_isCreatingPost)
              Positioned(
                bottom: 110,
                left: 20,
                right: 20,
          ...
          children: [
            ...
            Row(
              children: [
                GestureDetector(
                  onTap: () =>
                      ref.read(foroProvider.notifier).toggleLike(post['id']),
                  child: Row(
                    children: [
                      Text("$likes",
                          style: const TextStyle(
