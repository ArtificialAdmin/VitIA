              ...
              WidgetsBinding.instance.addPostFrameCallback((_) {
                if (mounted) {
                  try {
                    ...
                    debugPrint("MapController move failed (expected if not yet ready): $e");
                  }
                }
              });
           }
              ...
              if (imageUrl != null)
                ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    ...
                    errorWidget: (context, url, err) => Container(color: Colors.grey.shade200, child: const Icon(Icons.image_not_supported)),
                  ),
                ),
              ...
              Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      titulo,
                      style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 24, color: Color(0xFF2D3436)),
                    ),
                  ),
                  Container(
                ...
                children: [
                  ...
                  Expanded(
                    child: FutureBuilder<String>(
                      future: (lat != null && lon != null) ? _getDishplayAddress(lat, lon) : Future.value("Sin ubicación"),
                      builder: (context, snapshot) {
                        String address = snapshot.data ?? "Cargando dirección...";
                ...
                children: [
                  Expanded(
                    child: GestureDetector(
                      ...
                      child: Container(
                        decoration: _modo == 'publico' ? BoxDecoration(
                          color: Colors.white,
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            ...
                            fontSize: 15,
                            color: _modo == 'publico' ? Colors.black87 : Colors.grey.shade500,
                          ),
                        ),
                      ),
                    ),
                  ...
                  Expanded(
                    child: GestureDetector(
                      ...
                      child: Container(
                        decoration: _modo == 'privado' ? BoxDecoration(
                          color: Colors.white,
                          borderRadius: BorderRadius.circular(25),
                          boxShadow: [
                            BoxShadow(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            fontWeight: FontWeight.w600,
                            fontSize: 15,
                            color: _modo == 'privado' ? Colors.black87 : Colors.grey.shade500,
                          ),
                        ),
                      ),
                    ),
